...
export type HolyshipBadgeVariant = "green" | "amber" | "red" | "blue" | "muted";

const variantStyles: Record<HolyshipBadgeVariant, CSSProperties> = {
  green: {
...
interface HolyshipBadgeProps {
  variant?: HolyshipBadgeVariant;
  children: React.ReactNode;
  dot?: boolean;
}

export function HolyshipBadge({ variant = "muted", children, dot = false }: HolyshipBadgeProps) {
...
export function modelTierVariant(tier?: string): HolyshipBadgeVariant {
...
export function stateVariant(state: string): HolyshipBadgeVariant {
